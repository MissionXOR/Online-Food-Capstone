                        ...
                        <tbody>
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    $pizzaCal = $myrow['pizzaCal'];

                                    $total = $pizzaPrice * $Quantity;
                                    $counter++;
                                    $totalPrice = $totalPrice + $total;

                                    $totalCal = $pizzaCal * $Quantity;
                                    $countCalorie++;
                ...
                <div class="card wish-list mb-3">
                    <div class="pt-4 border bg-light rounded p-3">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3 bg-light">
                                <div>
                                    <strong>The total amount of Calories</strong>
                                </div>
                                <span><strong>Cal. <?php echo $totalCalories ?></strong></span>
                            </li>
                        </ul>
                        <div class="form-check">
                        <h5 class="mb-3 text-uppercase font-weight-bold text-center">Payment Method</h5>
                            ...
                            <img src="assets/img/team/OIP.jpg" class="img-fluid" alt="" style="height: 50px; width: 198px;">
                        </div>
