                ...
                <form action="partials/_orderManage.php" method="post">
                    ...
                    <div class="text-left my-2 row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" id="phone" name="phone" value="<?php echo $deliveryBoyPhoneNo; ?>" type="number" required pattern="[0-9]{10}">
                        </div>
                        <div class="form-group col-md-6">
...
<?php
    ...
    // Handle case where the query didn't return any results
